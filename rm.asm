...
main(int argc, char *argv[])
{
  ...
  5a:	c7 44 24 04 c4 0f 00 	movl   $0xfc4,0x4(%esp)
  61:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 42e:	0f b6 90 d4 14 00 00 	movzbl 0x14d4(%eax),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 58d:	75 27                	jne    5b6 <printf+0x11f>
          s = "(null)";
 58f:	c7 45 f4 dd 0f 00 00 	movl   $0xfdd,-0xc(%ebp)
        while(*s != 0){
...
print_stack()
{
 ...
 878:	c7 44 24 04 e4 0f 00 	movl   $0xfe4,0x4(%esp)
 87f:	00 
 ...
 895:	c7 44 24 04 fa 0f 00 	movl   $0xffa,0x4(%esp)
 89c:	00 
 ...
 8b2:	c7 44 24 04 02 10 00 	movl   $0x1002,0x4(%esp)
 8b9:	00 
...
{   
 ...
 aa0:	c7 44 24 04 0c 10 00 	movl   $0x100c,0x4(%esp)
 aa7:	00 
 ...
 ac9:	c7 44 24 04 2c 10 00 	movl   $0x102c,0x4(%esp)
 ad0:	00 
...
uthread_exit()
{
 ...
 cba:	79 19                	jns    cd5 <uthread_exit+0x160>
    {
      printf(1,"Cant activate alarm system call");
 cbc:	c7 44 24 04 2c 10 00 	movl   $0x102c,0x4(%esp)
 cc3:	00 
...
uthread_yield()
{
 ...
 da7:	0f 89 c1 00 00 00    	jns    e6e <uthread_yield+0xff>
    {
      printf(1,"Cant activate alarm system call\n");
 dad:	c7 44 24 04 4c 10 00 	movl   $0x104c,0x4(%esp)
 db4:	00 
 ...
 e29:	79 19                	jns    e44 <uthread_yield+0xd5>
    {
      printf(1,"Cant activate alarm system call\n");
 e2b:	c7 44 24 04 4c 10 00 	movl   $0x104c,0x4(%esp)
 e32:	00 
...
binary_semaphore_down(struct binary_semaphore* semaphore)
{
 ...
 efc:	c7 44 24 04 70 10 00 	movl   $0x1070,0x4(%esp)
 f03:	00 
...
binary_semaphore_up(struct binary_semaphore* semaphore)
{
 ...
 f68:	c7 44 24 04 a0 10 00 	movl   $0x10a0,0x4(%esp)
 f6f:	00 
