...
main(int argc, char *argv[])
{
  ...
  5a:	c7 44 24 04 37 0b 00 	movl   $0xb37,0x4(%esp)
  61:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 42e:	0f b6 90 ec 0e 00 00 	movzbl 0xeec(%eax),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 58d:	75 27                	jne    5b6 <printf+0x11f>
          s = "(null)";
 58f:	c7 45 f4 53 0b 00 00 	movl   $0xb53,-0xc(%ebp)
        while(*s != 0){
...
{  
 ...
 9f8:	c7 44 24 04 5c 0b 00 	movl   $0xb5c,0x4(%esp)
 9ff:	00 
 ...
 a21:	c7 44 24 04 7c 0b 00 	movl   $0xb7c,0x4(%esp)
 a28:	00 
...
uthread_yield()
{
 ...
 a82:	c7 44 24 04 9c 0b 00 	movl   $0xb9c,0x4(%esp)
 a89:	00 
 ...
 aa1:	c7 44 24 04 b5 0b 00 	movl   $0xbb5,0x4(%esp)
 aa8:	00 
