...
main(int argc, char **argv)
{
  ...
  if(argc < 1){
   ...
   f:	c7 44 24 04 90 0f 00 	movl   $0xf90,0x4(%esp)
  16:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 40e:	0f b6 90 9c 14 00 00 	movzbl 0x149c(%eax),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 56d:	75 27                	jne    596 <printf+0x11f>
          s = "(null)";
 56f:	c7 45 f4 a4 0f 00 00 	movl   $0xfa4,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 63b:	a1 c8 14 00 00       	mov    0x14c8,%eax
...
free(void *ap)
{
 ...
 6fc:	a3 c8 14 00 00       	mov    %eax,0x14c8
}
 701:	c9                   	leave  
 702:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 74f:	e8 d8 fe ff ff       	call   62c <free>
  return freep;
 754:	a1 c8 14 00 00       	mov    0x14c8,%eax
}
 759:	c9                   	leave  
 75a:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 76d:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 770:	a1 c8 14 00 00       	mov    0x14c8,%eax
 775:	89 45 f0             	mov    %eax,-0x10(%ebp)
 778:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 77c:	75 23                	jne    7a1 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 77e:	c7 45 f0 c0 14 00 00 	movl   $0x14c0,-0x10(%ebp)
 785:	8b 45 f0             	mov    -0x10(%ebp),%eax
 788:	a3 c8 14 00 00       	mov    %eax,0x14c8
 78d:	a1 c8 14 00 00       	mov    0x14c8,%eax
 792:	a3 c0 14 00 00       	mov    %eax,0x14c0
    base.s.size = 0;
 797:	c7 05 c4 14 00 00 00 	movl   $0x0,0x14c4
 79e:	00 00 00 
  }
 ...
 7f4:	a3 c8 14 00 00       	mov    %eax,0x14c8
      return (void*)(p + 1);
 ...
 7ff:	eb 38                	jmp    839 <malloc+0xde>
    ...
    if(p == freep)
 801:	a1 c8 14 00 00       	mov    0x14c8,%eax
...
print_stack()
{
  ...
  printf(1,"stack for thread %d \n",currentThread->tid);
  while((newesp < (int *)currentThread->ebp))
 8aa:	a1 e0 5d 00 00       	mov    0x5de0,%eax
 8af:	8b 40 08             	mov    0x8(%eax),%eax
 8b2:	3b 45 f4             	cmp    -0xc(%ebp),%eax
 8b5:	77 b7                	ja     86e <print_stack+0x32>
    printf(1,"add:%x ",newesp);
      printf(1,"val:%x\n",*newesp);
    newesp++;
  }
...
getNextThread(int j)
{
 ...
 8cc:	75 07                	jne    8d5 <getNextThread+0x1c>
    i=0;
 ...
 8de:	05 e0 14 00 00       	add    $0x14e0,%eax
 8e3:	89 45 f8             	mov    %eax,-0x8(%ebp)
  while(i!=j)
 8e6:	eb 3b                	jmp    923 <getNextThread+0x6a>
  {
    if(t->state==T_RUNNABLE)
 8e8:	8b 45 f8             	mov    -0x8(%ebp),%eax
 8eb:	8b 40 10             	mov    0x10(%eax),%eax
 8ee:	83 f8 03             	cmp    $0x3,%eax
 8f1:	75 05                	jne    8f8 <getNextThread+0x3f>
      return i;
 8f3:	8b 45 fc             	mov    -0x4(%ebp),%eax
 8f6:	eb 38                	jmp    930 <getNextThread+0x77>
    i++;
 8f8:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
    if(i==MAX_THREAD)
 8fc:	83 7d fc 40          	cmpl   $0x40,-0x4(%ebp)
 900:	75 1a                	jne    91c <getNextThread+0x63>
    {
     i=0;
 902:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
     t=&tTable.table[i];
 909:	8b 45 fc             	mov    -0x4(%ebp),%eax
 90c:	69 c0 24 01 00 00    	imul   $0x124,%eax,%eax
 912:	05 e0 14 00 00       	add    $0x14e0,%eax
 917:	89 45 f8             	mov    %eax,-0x8(%ebp)
 91a:	eb 07                	jmp    923 <getNextThread+0x6a>
   }
   else
    t++;
 91c:	81 45 f8 24 01 00 00 	addl   $0x124,-0x8(%ebp)
{
  int i=j+1;
  if(i==MAX_THREAD)
    i=0;
 ...
 926:	3b 45 08             	cmp    0x8(%ebp),%eax
 929:	75 bd                	jne    8e8 <getNextThread+0x2f>
   }
   else
    t++;
...
allocThread()
{
 ...
 938:	c7 45 ec e0 14 00 00 	movl   $0x14e0,-0x14(%ebp)
 93f:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
 946:	eb 15                	jmp    95d <allocThread+0x2b>
  {
    if(t->state==T_FREE)
 948:	8b 45 ec             	mov    -0x14(%ebp),%eax
 94b:	8b 40 10             	mov    0x10(%eax),%eax
 94e:	85 c0                	test   %eax,%eax
 950:	74 1e                	je     970 <allocThread+0x3e>
allocThread()
{
  int i,j;
  uthread_p t;
  ...
  for (t=tTable.table,i=0 ; t < &tTable.table[MAX_THREAD]; t++,i++)
 952:	81 45 ec 24 01 00 00 	addl   $0x124,-0x14(%ebp)
 959:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
 95d:	81 7d ec e0 5d 00 00 	cmpl   $0x5de0,-0x14(%ebp)
 964:	72 e2                	jb     948 <allocThread+0x16>
  {
    if(t->state==T_FREE)
      goto found;
  }
 ...
 96b:	e9 a3 00 00 00       	jmp    a13 <allocThread+0xe1>
  uthread_p t;
 ...
 974:	8b 55 f4             	mov    -0xc(%ebp),%edx
 977:	89 10                	mov    %edx,(%eax)
  if(i==0) //main thread init
 979:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
 97d:	75 1c                	jne    99b <allocThread+0x69>
  {
    STORE_ESP(t->esp);
 97f:	89 e2                	mov    %esp,%edx
 981:	8b 45 ec             	mov    -0x14(%ebp),%eax
 984:	89 50 04             	mov    %edx,0x4(%eax)
    STORE_EBP(t->ebp);
 987:	89 ea                	mov    %ebp,%edx
 989:	8b 45 ec             	mov    -0x14(%ebp),%eax
 98c:	89 50 08             	mov    %edx,0x8(%eax)
    t->firstTime=0;
 98f:	8b 45 ec             	mov    -0x14(%ebp),%eax
 992:	c7 40 14 00 00 00 00 	movl   $0x0,0x14(%eax)
 999:	eb 3b                	jmp    9d6 <allocThread+0xa4>
  }
  else
  {
    t->stack=(char*)malloc(STACK_SIZE);
 99b:	c7 04 24 00 10 00 00 	movl   $0x1000,(%esp)
 9a2:	e8 b4 fd ff ff       	call   75b <malloc>
 9a7:	8b 55 ec             	mov    -0x14(%ebp),%edx
 9aa:	89 42 0c             	mov    %eax,0xc(%edx)
    t->ebp=(int)t->stack+STACK_SIZE;
 9ad:	8b 45 ec             	mov    -0x14(%ebp),%eax
 9b0:	8b 40 0c             	mov    0xc(%eax),%eax
 9b3:	05 00 10 00 00       	add    $0x1000,%eax
 9b8:	89 c2                	mov    %eax,%edx
 9ba:	8b 45 ec             	mov    -0x14(%ebp),%eax
 9bd:	89 50 08             	mov    %edx,0x8(%eax)
    t->esp=t->ebp;
 9c0:	8b 45 ec             	mov    -0x14(%ebp),%eax
 9c3:	8b 50 08             	mov    0x8(%eax),%edx
 9c6:	8b 45 ec             	mov    -0x14(%ebp),%eax
 9c9:	89 50 04             	mov    %edx,0x4(%eax)
    t->firstTime=1;
 9cc:	8b 45 ec             	mov    -0x14(%ebp),%eax
 9cf:	c7 40 14 01 00 00 00 	movl   $0x1,0x14(%eax)
  }
  
  t->waitingFor=-1;
 9d6:	8b 45 ec             	mov    -0x14(%ebp),%eax
 9d9:	c7 80 20 01 00 00 ff 	movl   $0xffffffff,0x120(%eax)
 9e0:	ff ff ff 
  
  for(j=0;j<MAX_THREAD;j++)
 9e3:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
 9ea:	eb 14                	jmp    a00 <allocThread+0xce>
  {
    t->waitedOn[j]=-1;
 9ec:	8b 45 ec             	mov    -0x14(%ebp),%eax
 9ef:	8b 55 f0             	mov    -0x10(%ebp),%edx
 9f2:	83 c2 08             	add    $0x8,%edx
 9f5:	c7 04 90 ff ff ff ff 	movl   $0xffffffff,(%eax,%edx,4)
    t->firstTime=1;
  }
  ...
  for(j=0;j<MAX_THREAD;j++)
 9fc:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
 a00:	83 7d f0 3f          	cmpl   $0x3f,-0x10(%ebp)
 a04:	7e e6                	jle    9ec <allocThread+0xba>
  {
    t->waitedOn[j]=-1;
  }
 ...
 a09:	c7 40 10 01 00 00 00 	movl   $0x1,0x10(%eax)
...
{   
 ...
 a22:	eb 18                	jmp    a3c <uthread_init+0x27>
  {
    tTable.table[i].state=T_FREE;
 a24:	8b 45 f4             	mov    -0xc(%ebp),%eax
 a27:	69 c0 24 01 00 00    	imul   $0x124,%eax,%eax
 a2d:	05 f0 14 00 00       	add    $0x14f0,%eax
 a32:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
uthread_init()
{   
  //Initialize table
  int i;
 ...
 a3c:	83 7d f4 3f          	cmpl   $0x3f,-0xc(%ebp)
 a40:	7e e2                	jle    a24 <uthread_init+0xf>
  {
    tTable.table[i].state=T_FREE;
  }
 ...
 a42:	e8 eb fe ff ff       	call   932 <allocThread>
 a47:	a3 e0 5d 00 00       	mov    %eax,0x5de0
  if(currentThread==0)
 a4c:	a1 e0 5d 00 00       	mov    0x5de0,%eax
 a51:	85 c0                	test   %eax,%eax
 a53:	75 07                	jne    a5c <uthread_init+0x47>
    return -1;
 a55:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
 a5a:	eb 6b                	jmp    ac7 <uthread_init+0xb2>
  
  currentThread->state = T_RUNNING;
 a5c:	a1 e0 5d 00 00       	mov    0x5de0,%eax
 a61:	c7 40 10 02 00 00 00 	movl   $0x2,0x10(%eax)
  //register uthread_yield as signal handler for alarm
  if(signal(SIGALRM,uthread_yield)<0)
 a68:	c7 44 24 04 4f 0d 00 	movl   $0xd4f,0x4(%esp)
 a6f:	00 
 a70:	c7 04 24 0e 00 00 00 	movl   $0xe,(%esp)
 a77:	e8 0c f9 ff ff       	call   388 <signal>
 a7c:	85 c0                	test   %eax,%eax
 a7e:	79 19                	jns    a99 <uthread_init+0x84>
  {
    printf(1,"Cant register the alarm signal");
 a80:	c7 44 24 04 d4 0f 00 	movl   $0xfd4,0x4(%esp)
 a87:	00 
 a88:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 a8f:	e8 e3 f9 ff ff       	call   477 <printf>
    exit();
 a94:	e8 2f f8 ff ff       	call   2c8 <exit>
  }
  //set new alarm clock
  if(alarm(THREAD_QUANTA)<0)
 a99:	c7 04 24 05 00 00 00 	movl   $0x5,(%esp)
 aa0:	e8 f3 f8 ff ff       	call   398 <alarm>
 aa5:	85 c0                	test   %eax,%eax
 aa7:	79 19                	jns    ac2 <uthread_init+0xad>
  {
    printf(1,"Cant activate alarm system call");
 aa9:	c7 44 24 04 f4 0f 00 	movl   $0xff4,0x4(%esp)
 ab0:	00 
 ab1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 ab8:	e8 ba f9 ff ff       	call   477 <printf>
    exit();
 abd:	e8 06 f8 ff ff       	call   2c8 <exit>
  }
  return 0;
...
wrap_func()
{
 ...
 acf:	a1 e0 5d 00 00       	mov    0x5de0,%eax
 ad4:	8b 50 18             	mov    0x18(%eax),%edx
 ad7:	a1 e0 5d 00 00       	mov    0x5de0,%eax
 adc:	8b 40 1c             	mov    0x1c(%eax),%eax
 adf:	89 04 24             	mov    %eax,(%esp)
 ae2:	ff d2                	call   *%edx
  uthread_exit();
 ae4:	e8 6c 00 00 00       	call   b55 <uthread_exit>
}
 ae9:	c9                   	leave  
 aea:	c3                   	ret    

00000aeb <uthread_create>:
 * to that function
...
uthread_create(void (*start_func)(void *), void* arg)
{
 ...
 b29:	8b 50 08             	mov    0x8(%eax),%edx
 b2c:	b8 c9 0a 00 00       	mov    $0xac9,%eax
 b31:	50                   	push   %eax
 b32:	52                   	push   %edx
 b33:	89 e2                	mov    %esp,%edx
 b35:	8b 45 f4             	mov    -0xc(%ebp),%eax
 b38:	89 50 04             	mov    %edx,0x4(%eax)
  LOAD_ESP(local_esp);
 b3b:	8b 45 f0             	mov    -0x10(%ebp),%eax
 b3e:	89 c4                	mov    %eax,%esp
  
  t->state = T_RUNNABLE;
 b40:	8b 45 f4             	mov    -0xc(%ebp),%eax
 b43:	c7 40 10 03 00 00 00 	movl   $0x3,0x10(%eax)
  
  return t->tid;
 b4a:	8b 45 f4             	mov    -0xc(%ebp),%eax
 b4d:	8b 00                	mov    (%eax),%eax
}
 b4f:	83 c4 14             	add    $0x14,%esp
 b52:	5b                   	pop    %ebx
 b53:	5d                   	pop    %ebp
 b54:	c3                   	ret    

00000b55 <uthread_exit>:
...
uthread_exit()
{
 ...
 b62:	e8 31 f8 ff ff       	call   398 <alarm>
  int new,i;
  //wakeup all threads waiting for this one
  for(i=0;i<MAX_THREAD;i++)
 b67:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
 b6e:	eb 51                	jmp    bc1 <uthread_exit+0x6c>
  {
   if(currentThread->waitedOn[i]==1)
 b70:	a1 e0 5d 00 00       	mov    0x5de0,%eax
 b75:	8b 55 f4             	mov    -0xc(%ebp),%edx
 b78:	83 c2 08             	add    $0x8,%edx
 b7b:	8b 04 90             	mov    (%eax,%edx,4),%eax
 b7e:	83 f8 01             	cmp    $0x1,%eax
 b81:	75 3a                	jne    bbd <uthread_exit+0x68>
   {
     tTable.table[i].waitingFor=-1; //release thread i from waiting
 b83:	8b 45 f4             	mov    -0xc(%ebp),%eax
 b86:	69 c0 24 01 00 00    	imul   $0x124,%eax,%eax
 b8c:	05 00 16 00 00       	add    $0x1600,%eax
 b91:	c7 00 ff ff ff ff    	movl   $0xffffffff,(%eax)
     currentThread->waitedOn[i]=0; //not necessary maybe   
 b97:	a1 e0 5d 00 00       	mov    0x5de0,%eax
 b9c:	8b 55 f4             	mov    -0xc(%ebp),%edx
 b9f:	83 c2 08             	add    $0x8,%edx
 ba2:	c7 04 90 00 00 00 00 	movl   $0x0,(%eax,%edx,4)
     tTable.table[i].state=T_RUNNABLE;
 ba9:	8b 45 f4             	mov    -0xc(%ebp),%eax
 bac:	69 c0 24 01 00 00    	imul   $0x124,%eax,%eax
 bb2:	05 f0 14 00 00       	add    $0x14f0,%eax
 bb7:	c7 00 03 00 00 00    	movl   $0x3,(%eax)
uthread_exit()
{
  alarm(0); //clear the alarm so as not to disturb running of function
  int new,i;
  //wakeup all threads waiting for this one
  for(i=0;i<MAX_THREAD;i++)
 bbd:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
 bc1:	83 7d f4 3f          	cmpl   $0x3f,-0xc(%ebp)
 bc5:	7e a9                	jle    b70 <uthread_exit+0x1b>
     tTable.table[i].state=T_RUNNABLE;
   }
  }
 ...
 bc7:	a1 e0 5d 00 00       	mov    0x5de0,%eax
 bcc:	8b 00                	mov    (%eax),%eax
 bce:	89 04 24             	mov    %eax,(%esp)
 bd1:	e8 e3 fc ff ff       	call   8b9 <getNextThread>
 bd6:	89 45 f0             	mov    %eax,-0x10(%ebp)
  
  //release all resources and zero all fields
  if(currentThread->tid!=0)
 bd9:	a1 e0 5d 00 00       	mov    0x5de0,%eax
 bde:	8b 00                	mov    (%eax),%eax
 be0:	85 c0                	test   %eax,%eax
 be2:	74 10                	je     bf4 <uthread_exit+0x9f>
    free(currentThread->stack);
 be4:	a1 e0 5d 00 00       	mov    0x5de0,%eax
 be9:	8b 40 0c             	mov    0xc(%eax),%eax
 bec:	89 04 24             	mov    %eax,(%esp)
 bef:	e8 38 fa ff ff       	call   62c <free>
  currentThread->tid=-1;
 bf4:	a1 e0 5d 00 00       	mov    0x5de0,%eax
 bf9:	c7 00 ff ff ff ff    	movl   $0xffffffff,(%eax)
  currentThread->esp=-1;
 bff:	a1 e0 5d 00 00       	mov    0x5de0,%eax
 c04:	c7 40 04 ff ff ff ff 	movl   $0xffffffff,0x4(%eax)
  currentThread->ebp=-1;
 c0b:	a1 e0 5d 00 00       	mov    0x5de0,%eax
 c10:	c7 40 08 ff ff ff ff 	movl   $0xffffffff,0x8(%eax)
  currentThread->func=0;
 c17:	a1 e0 5d 00 00       	mov    0x5de0,%eax
 c1c:	c7 40 18 00 00 00 00 	movl   $0x0,0x18(%eax)
  currentThread->arguments=0;
 c23:	a1 e0 5d 00 00       	mov    0x5de0,%eax
 c28:	c7 40 1c 00 00 00 00 	movl   $0x0,0x1c(%eax)
  currentThread->stack=0;
 c2f:	a1 e0 5d 00 00       	mov    0x5de0,%eax
 c34:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
  currentThread->firstTime=1;
 c3b:	a1 e0 5d 00 00       	mov    0x5de0,%eax
 c40:	c7 40 14 01 00 00 00 	movl   $0x1,0x14(%eax)
  currentThread->state=T_FREE;
 c47:	a1 e0 5d 00 00       	mov    0x5de0,%eax
 c4c:	c7 40 10 00 00 00 00 	movl   $0x0,0x10(%eax)
  
  //load new thread
  if(new>=0)
 c53:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 c57:	78 7a                	js     cd3 <uthread_exit+0x17e>
  {
    currentThread=&tTable.table[new];
 c59:	8b 45 f0             	mov    -0x10(%ebp),%eax
 c5c:	69 c0 24 01 00 00    	imul   $0x124,%eax,%eax
 c62:	05 e0 14 00 00       	add    $0x14e0,%eax
 c67:	a3 e0 5d 00 00       	mov    %eax,0x5de0
    currentThread->state=T_RUNNING;
 c6c:	a1 e0 5d 00 00       	mov    0x5de0,%eax
 c71:	c7 40 10 02 00 00 00 	movl   $0x2,0x10(%eax)
    LOAD_ESP(currentThread->esp);
 c78:	a1 e0 5d 00 00       	mov    0x5de0,%eax
 c7d:	8b 40 04             	mov    0x4(%eax),%eax
 c80:	89 c4                	mov    %eax,%esp
    LOAD_EBP(currentThread->ebp);
 c82:	a1 e0 5d 00 00       	mov    0x5de0,%eax
 c87:	8b 40 08             	mov    0x8(%eax),%eax
 c8a:	89 c5                	mov    %eax,%ebp
    
    //set new alarm clock
    if(alarm(THREAD_QUANTA)<0)
 c8c:	c7 04 24 05 00 00 00 	movl   $0x5,(%esp)
 c93:	e8 00 f7 ff ff       	call   398 <alarm>
 c98:	85 c0                	test   %eax,%eax
 c9a:	79 19                	jns    cb5 <uthread_exit+0x160>
    {
      printf(1,"Cant activate alarm system call");
 c9c:	c7 44 24 04 f4 0f 00 	movl   $0xff4,0x4(%esp)
 ca3:	00 
 ca4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 cab:	e8 c7 f7 ff ff       	call   477 <printf>
      exit();
 cb0:	e8 13 f6 ff ff       	call   2c8 <exit>
    }
    
    if(currentThread->firstTime==1)
 cb5:	a1 e0 5d 00 00       	mov    0x5de0,%eax
 cba:	8b 40 14             	mov    0x14(%eax),%eax
 cbd:	83 f8 01             	cmp    $0x1,%eax
 cc0:	75 10                	jne    cd2 <uthread_exit+0x17d>
    {
      currentThread->firstTime=0;
 cc2:	a1 e0 5d 00 00       	mov    0x5de0,%eax
 cc7:	c7 40 14 00 00 00 00 	movl   $0x0,0x14(%eax)
      POP_AND_RET();
 cce:	5d                   	pop    %ebp
 ccf:	c3                   	ret    
 cd0:	eb 01                	jmp    cd3 <uthread_exit+0x17e>
    }
    else
    {  
    POP_ALL_REGISTERS();
...
uthread_join(int tid)
{
 ...
 cde:	69 c0 24 01 00 00    	imul   $0x124,%eax,%eax
 ce4:	05 e0 14 00 00       	add    $0x14e0,%eax
 ce9:	8b 40 10             	mov    0x10(%eax),%eax
 cec:	85 c0                	test   %eax,%eax
 cee:	75 07                	jne    cf7 <uthread_join+0x22>
    return -1;
 cf0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
 cf5:	eb 56                	jmp    d4d <uthread_join+0x78>
  else
  {
    alarm(0); //clear the alarm so as not to disturb running of function
 cf7:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
 cfe:	e8 95 f6 ff ff       	call   398 <alarm>
    currentThread->waitingFor=tid;
 d03:	a1 e0 5d 00 00       	mov    0x5de0,%eax
 d08:	8b 55 08             	mov    0x8(%ebp),%edx
 d0b:	89 90 20 01 00 00    	mov    %edx,0x120(%eax)
    tTable.table[tid].waitedOn[currentThread->tid]=1;
 d11:	a1 e0 5d 00 00       	mov    0x5de0,%eax
 d16:	8b 08                	mov    (%eax),%ecx
 d18:	8b 55 08             	mov    0x8(%ebp),%edx
 d1b:	89 d0                	mov    %edx,%eax
 d1d:	c1 e0 03             	shl    $0x3,%eax
 d20:	01 d0                	add    %edx,%eax
 d22:	c1 e0 03             	shl    $0x3,%eax
 d25:	01 d0                	add    %edx,%eax
 d27:	01 c8                	add    %ecx,%eax
 d29:	83 c0 08             	add    $0x8,%eax
 d2c:	c7 04 85 e0 14 00 00 	movl   $0x1,0x14e0(,%eax,4)
 d33:	01 00 00 00 
    currentThread->state=T_SLEEPING;
 d37:	a1 e0 5d 00 00       	mov    0x5de0,%eax
 d3c:	c7 40 10 04 00 00 00 	movl   $0x4,0x10(%eax)
    uthread_yield();
 d43:	e8 07 00 00 00       	call   d4f <uthread_yield>
    return 1;
...
uthread_yield()
{
 ...
 d52:	83 ec 28             	sub    $0x28,%esp
  alarm(0); //clear the alarm so as not to disturb running of function
 d55:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
 d5c:	e8 37 f6 ff ff       	call   398 <alarm>
  int new=getNextThread(currentThread->tid);
 d61:	a1 e0 5d 00 00       	mov    0x5de0,%eax
 d66:	8b 00                	mov    (%eax),%eax
 d68:	89 04 24             	mov    %eax,(%esp)
 d6b:	e8 49 fb ff ff       	call   8b9 <getNextThread>
 d70:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(new==-1)
 d73:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
 d77:	75 2d                	jne    da6 <uthread_yield+0x57>
  {
    if(alarm(THREAD_QUANTA)<0)
 d79:	c7 04 24 05 00 00 00 	movl   $0x5,(%esp)
 d80:	e8 13 f6 ff ff       	call   398 <alarm>
 d85:	85 c0                	test   %eax,%eax
 d87:	0f 89 c1 00 00 00    	jns    e4e <uthread_yield+0xff>
    {
      printf(1,"Cant activate alarm system call\n");
 d8d:	c7 44 24 04 14 10 00 	movl   $0x1014,0x4(%esp)
 d94:	00 
 d95:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 d9c:	e8 d6 f6 ff ff       	call   477 <printf>
      exit();
 da1:	e8 22 f5 ff ff       	call   2c8 <exit>
    } 
  }
  else
  {
 ...
 da7:	a1 e0 5d 00 00       	mov    0x5de0,%eax
 dac:	89 e2                	mov    %esp,%edx
 dae:	89 50 04             	mov    %edx,0x4(%eax)
    STORE_EBP(currentThread->ebp);
 db1:	a1 e0 5d 00 00       	mov    0x5de0,%eax
 db6:	89 ea                	mov    %ebp,%edx
 db8:	89 50 08             	mov    %edx,0x8(%eax)
    
    //change thread state
    if(currentThread->state==T_RUNNING) //might be sleeping from join operation
 dbb:	a1 e0 5d 00 00       	mov    0x5de0,%eax
 dc0:	8b 40 10             	mov    0x10(%eax),%eax
 dc3:	83 f8 02             	cmp    $0x2,%eax
 dc6:	75 0c                	jne    dd4 <uthread_yield+0x85>
      currentThread->state=T_RUNNABLE;
 dc8:	a1 e0 5d 00 00       	mov    0x5de0,%eax
 dcd:	c7 40 10 03 00 00 00 	movl   $0x3,0x10(%eax)

    currentThread=&tTable.table[new];
 dd4:	8b 45 f4             	mov    -0xc(%ebp),%eax
 dd7:	69 c0 24 01 00 00    	imul   $0x124,%eax,%eax
 ddd:	05 e0 14 00 00       	add    $0x14e0,%eax
 de2:	a3 e0 5d 00 00       	mov    %eax,0x5de0

    //load all new thread registers and pointers
    LOAD_ESP(currentThread->esp);
 de7:	a1 e0 5d 00 00       	mov    0x5de0,%eax
 dec:	8b 40 04             	mov    0x4(%eax),%eax
 def:	89 c4                	mov    %eax,%esp
    LOAD_EBP(currentThread->ebp);
 df1:	a1 e0 5d 00 00       	mov    0x5de0,%eax
 df6:	8b 40 08             	mov    0x8(%eax),%eax
 df9:	89 c5                	mov    %eax,%ebp
    //set new alram clock
    if(alarm(THREAD_QUANTA)<0)
 dfb:	c7 04 24 05 00 00 00 	movl   $0x5,(%esp)
 e02:	e8 91 f5 ff ff       	call   398 <alarm>
 e07:	85 c0                	test   %eax,%eax
 e09:	79 19                	jns    e24 <uthread_yield+0xd5>
    {
      printf(1,"Cant activate alarm system call\n");
 e0b:	c7 44 24 04 14 10 00 	movl   $0x1014,0x4(%esp)
 e12:	00 
 e13:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 e1a:	e8 58 f6 ff ff       	call   477 <printf>
      exit();
 e1f:	e8 a4 f4 ff ff       	call   2c8 <exit>
    }  
    currentThread->state=T_RUNNING;
 e24:	a1 e0 5d 00 00       	mov    0x5de0,%eax
 e29:	c7 40 10 02 00 00 00 	movl   $0x2,0x10(%eax)
    
    if(currentThread->firstTime==1)
 e30:	a1 e0 5d 00 00       	mov    0x5de0,%eax
 e35:	8b 40 14             	mov    0x14(%eax),%eax
 e38:	83 f8 01             	cmp    $0x1,%eax
 e3b:	75 10                	jne    e4d <uthread_yield+0xfe>
    {
    currentThread->firstTime=0;
 e3d:	a1 e0 5d 00 00       	mov    0x5de0,%eax
 e42:	c7 40 14 00 00 00 00 	movl   $0x0,0x14(%eax)
    POP_AND_RET();
 e49:	5d                   	pop    %ebp
 e4a:	c3                   	ret    
 e4b:	eb 01                	jmp    e4e <uthread_yield+0xff>
    }
    else
    {
      POP_ALL_REGISTERS();
...
uthread_self(void)
{
 ...
 e53:	a1 e0 5d 00 00       	mov    0x5de0,%eax
...
xchg(volatile uint *addr, uint newval)
{
 ...
 e5f:	53                   	push   %ebx
 e60:	83 ec 10             	sub    $0x10,%esp
  uint result;
  
  // The + in "+m" denotes a read-modify-write operand.
  asm volatile("lock; xchgl %0, %1" :
               "+m" (*addr), "=a" (result) :
 e63:	8b 55 08             	mov    0x8(%ebp),%edx
xchg(volatile uint *addr, uint newval)
{
  uint result;
...
xchg(volatile uint *addr, uint newval)
{
  ...
  // The + in "+m" denotes a read-modify-write operand.
  asm volatile("lock; xchgl %0, %1" :
 e6c:	89 c3                	mov    %eax,%ebx
 e6e:	89 d8                	mov    %ebx,%eax
 e70:	f0 87 02             	lock xchg %eax,(%edx)
 e73:	89 c3                	mov    %eax,%ebx
 e75:	89 5d f8             	mov    %ebx,-0x8(%ebp)
               "+m" (*addr), "=a" (result) :
               "1" (newval) :
               "cc");
  return result;
 e78:	8b 45 f8             	mov    -0x8(%ebp),%eax
}
...
binary_semaphore_init(struct binary_semaphore* semaphore, int value)
{
 ...
 e8a:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
  ...
  if(value!=0)
 e91:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
 e95:	74 0c                	je     ea3 <binary_semaphore_init+0x22>
    semaphore->thread=-1;
 e97:	8b 45 08             	mov    0x8(%ebp),%eax
 e9a:	c7 40 04 ff ff ff ff 	movl   $0xffffffff,0x4(%eax)
 ea1:	eb 0b                	jmp    eae <binary_semaphore_init+0x2d>
  else 
    semaphore->thread = uthread_self();
 ea3:	e8 a8 ff ff ff       	call   e50 <uthread_self>
 ea8:	8b 55 08             	mov    0x8(%ebp),%edx
 eab:	89 42 04             	mov    %eax,0x4(%edx)
  
  semaphore->locked = value;
 eae:	8b 55 0c             	mov    0xc(%ebp),%edx
 eb1:	8b 45 08             	mov    0x8(%ebp),%eax
 eb4:	89 10                	mov    %edx,(%eax)
 // semaphore->taken=0;
  semaphore->init=1;
 eb6:	8b 45 08             	mov    0x8(%ebp),%eax
 eb9:	c7 40 08 01 00 00 00 	movl   $0x1,0x8(%eax)
  
}
 ec0:	c9                   	leave  
 ec1:	c3                   	ret    

00000ec2 <binary_semaphore_down>:
...
binary_semaphore_down(struct binary_semaphore* semaphore)
{
 ...
 ec5:	83 ec 28             	sub    $0x28,%esp
  //semaphore_acquire(semaphore);
  if(semaphore->init==0)
 ec8:	8b 45 08             	mov    0x8(%ebp),%eax
 ecb:	8b 40 08             	mov    0x8(%eax),%eax
 ece:	85 c0                	test   %eax,%eax
 ed0:	75 20                	jne    ef2 <binary_semaphore_down+0x30>
  {
   printf(1,"(down)semaphore uninitialized yet (thread %d)\n",semaphore->thread);
 ed2:	8b 45 08             	mov    0x8(%ebp),%eax
 ed5:	8b 40 04             	mov    0x4(%eax),%eax
 ed8:	89 44 24 08          	mov    %eax,0x8(%esp)
 edc:	c7 44 24 04 38 10 00 	movl   $0x1038,0x4(%esp)
 ee3:	00 
 ee4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 eeb:	e8 87 f5 ff ff       	call   477 <printf>
    return;
 ef0:	eb 3a                	jmp    f2c <binary_semaphore_down+0x6a>
  }
  
  
  int i= uthread_self();
 ef2:	e8 59 ff ff ff       	call   e50 <uthread_self>
 ef7:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(semaphore->thread!=i)
 efa:	8b 45 08             	mov    0x8(%ebp),%eax
 efd:	8b 40 04             	mov    0x4(%eax),%eax
 f00:	3b 45 f4             	cmp    -0xc(%ebp),%eax
 f03:	74 27                	je     f2c <binary_semaphore_down+0x6a>
  {
    while(xchg(&semaphore->locked, 0) == 0) //means the semaphore is taken allready
 f05:	eb 05                	jmp    f0c <binary_semaphore_down+0x4a>
    {
      uthread_yield();
 f07:	e8 43 fe ff ff       	call   d4f <uthread_yield>
 ...
 f1a:	e8 3d ff ff ff       	call   e5c <xchg>
 f1f:	85 c0                	test   %eax,%eax
 f21:	74 e4                	je     f07 <binary_semaphore_down+0x45>
    {
      uthread_yield();
    }
    semaphore->thread = i;
 f23:	8b 45 08             	mov    0x8(%ebp),%eax
 f26:	8b 55 f4             	mov    -0xc(%ebp),%edx
...
binary_semaphore_up(struct binary_semaphore* semaphore)
{
 ...
 f3c:	75 20                	jne    f5e <binary_semaphore_up+0x30>
    {
    printf(1,"(up)semaphore uninitialized yet (thread %d)\n",semaphore->thread);
 f3e:	8b 45 08             	mov    0x8(%ebp),%eax
 f41:	8b 40 04             	mov    0x4(%eax),%eax
 f44:	89 44 24 08          	mov    %eax,0x8(%esp)
 f48:	c7 44 24 04 68 10 00 	movl   $0x1068,0x4(%esp)
 f4f:	00 
 f50:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 f57:	e8 1b f5 ff ff       	call   477 <printf>
    return;
 f5c:	eb 2f                	jmp    f8d <binary_semaphore_up+0x5f>
    }
  
  int i= uthread_self();
 f5e:	e8 ed fe ff ff       	call   e50 <uthread_self>
 f63:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if( semaphore->locked == 0 && semaphore->thread == i)
 f66:	8b 45 08             	mov    0x8(%ebp),%eax
 f69:	8b 00                	mov    (%eax),%eax
 f6b:	85 c0                	test   %eax,%eax
 f6d:	75 1e                	jne    f8d <binary_semaphore_up+0x5f>
 f6f:	8b 45 08             	mov    0x8(%ebp),%eax
 f72:	8b 40 04             	mov    0x4(%eax),%eax
 f75:	3b 45 f4             	cmp    -0xc(%ebp),%eax
 f78:	75 13                	jne    f8d <binary_semaphore_up+0x5f>
  {
      semaphore->thread = -1;
 f7a:	8b 45 08             	mov    0x8(%ebp),%eax
 f7d:	c7 40 04 ff ff ff ff 	movl   $0xffffffff,0x4(%eax)
      semaphore->locked = 1;
 f84:	8b 45 08             	mov    0x8(%ebp),%eax
 f87:	c7 00 01 00 00 00    	movl   $0x1,(%eax)
